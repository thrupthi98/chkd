...
router.get("/average",(req,res) => {
    Surgery.aggregate([{$group: {_id:null, avg_checkin: {$avg:"$checkin"},avg_Insurgery: {$avg:"$inSurgery"},avg_postSurgery: {$avg:"$postSurgery"},avg_discharged: {$avg:"$discharged"} } }]).then(response => {
